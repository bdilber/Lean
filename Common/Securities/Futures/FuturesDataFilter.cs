...
namespace QuantConnect.Securities.Futures
{
    ...
    *********************************************************/
    /// <summary>
    /// Futures security type data filter 
    /// </summary>
    /// <seealso cref="SecurityDataFilter"/>
    public class FuturesDataFilter : SecurityDataFilter
    {
        /******************************************************** 
        * CLASS VARIABLES
        *********************************************************/
        ...
        *********************************************************/
        /// <summary>
        /// Futures filter the data: true - accept, false - fail.
        /// </summary>
